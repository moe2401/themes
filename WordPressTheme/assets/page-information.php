        ...
        <div class="sub-mv__inner">
          <picture class="sub-mv__img">
            <source
              ...
              srcset="<?php echo get_theme_file_uri(); ?>/images/sub/sub-info-sp-img.jpg"
            />
            <img
              src="<?php echo get_theme_file_uri(); ?>/images/sub/sub-info-pc-img.jpg"
              alt="2匹の黄色い魚が泳いでいる様子"
            />
          </picture>
        </div>
          ...
          <div class="sub-information__contents">
            <div class="sub-information__tab tab-info">
              <ul class="tab-info__menu">
                <li
                  class="tab-info__menu-item js-tab-info-menu current"
                  data-number="tab01"
                >
                ...
                <li
                  class="tab-info__menu-item js-tab-info-menu"
                  data-number="tab02"
                >
              ...
              <ul class="tab-info__content">
                <li
                  id="tab01"
                  class="tab-info__content-item js-tab-info-content current"
                >
                  <a href="#" class="info-card">
                    <div class="info-card__body">
                      ...
                      <div class="info-card__img">
                        <img
                          src="<?php echo get_theme_file_uri(); ?>/images/sub/license.jpg"
                          alt="5人おダイバーが海に浮かんでいる様子"
                        />
                      </div>
                    </div>
                  </a>
                ...
                <li
                  id="tab02"
                  class="tab-info__content-item js-tab-info-content"
                >
                  <a href="#" class="info-card">
                    <div class="info-card__body">
                      <div class="info-card__content">
                      ...
                      <div class="info-card__img">
                        <img
                          src="<?php echo get_theme_file_uri(); ?>/images/sub/fundiving.jpg"
                          alt="5人のダイバーが海に浮かんでいる様子"
                        />
                      </div>
                    </div>
                  </a>
                ...
                >
                  <a href="#" class="info-card">
                    <div class="info-card__body">
                      ...
                      <div class="info-card__img">
                        <img
                          src="<?php echo get_theme_file_uri(); ?>/images/sub/sub-aboutus_3.jpg"
                          alt="5人おダイバーが海に浮かんでいる様子"
                        />
                      </div>
                    </div>
