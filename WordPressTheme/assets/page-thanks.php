        ...
        <div class="sub-mv__inner">
          <picture class="sub-mv__img">
            <source
              ...
              srcset="<?php echo get_theme_file_uri(); ?>/images/sub/sub-contact-sp-img.jpg"
            />
            <img
              src="<?php echo get_theme_file_uri(); ?>/images/sub/sub-contact-pc-img.jpg"
              alt="海岸に波が押し寄せている様子"
            />
          </picture>
        </div>
