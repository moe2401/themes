            ...
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <picture class="mv__img">
                  <source
                    ...
                    srcset="./assets/images/common/mv_1.jpg"
                  />
                  <img src="<?php echo get_theme_file_uri(); ?>/images/common/mv_1-pc.jpg" alt="海亀が泳いでいる様子"
                  />
                </picture>
              </div>
              <div class="swiper-slide">
                <picture class="mv__img">
                  <source
                    media="(max-width: 768px)"
                    srcset="./assets/images/common/mv_2.jpg"
                  />
                  <img src="<?php echo get_theme_file_uri(); ?>/images/common/mv_2-pc.jpg" alt="海の中の海亀の様子"
                  />
                </picture>
              </div>
              <div class="swiper-slide">
                <picture class="mv__img">
                  <source
                    media="(max-width: 768px)"
                    srcset="./assets/images/common/mv_3.jpg"
                  />
                  <img
                    src="./assets/images/common/mv_3-pc.jpg"
                    alt="海と船が止まっている様子"
                  />
                </picture>
              </div>
              <div class="swiper-slide">
                <picture class="mv__img">
                  <source
                    media="(max-width: 768px)"
                    srcset="./assets/images/common/mv_4.jpg"
                  />
                  <img src="<?php echo get_theme_file_uri(); ?>/images/common/mv_4-pc.jpg" alt="綺麗な海岸の様子"
                  />
                </picture>
              </div>
            </div>
            ...
            <div class="js-campaign-swiper swiper">
              <ul class="campaign__swiper-wrapper swiper-wrapper">
                <li class="campaign__slide swiper-slide">
                  <div class="campaign-card">
                    <div class="campaign-card__img">
                      <img src="<?php echo get_theme_file_uri(); ?>/images/common/campaign_1.jpg" alt="海の中を色鮮やかなたくさんの魚が泳いでいる様子"
                      />
                    </div>
                ...
                <li class="campaign__slide swiper-slide">
                  <div class="campaign-card">
                    <div class="campaign-card__img">
                      <img src="<?php echo get_theme_file_uri(); ?>/images/common/campaign_2.jpg" alt="透明感のある海と停まっている船の様子"
                      />
                    </div>
                    <div class="campaign-card__item-body">
                      <div class="campaign-card__meta">
                ...
                <li class="campaign__slide swiper-slide">
                  <div class="campaign-card">
                    <div class="campaign-card__img">
                      <img src="<?php echo get_theme_file_uri(); ?>/images/common/campaign_3.jpg" alt="夜の海をたくさんのクラゲが泳いでいる様子"
                      />
                    </div>
                    <div class="campaign-card__item-body">
                      <div class="campaign-card__meta">
                ...
                <li class="campaign__slide swiper-slide">
                  <div class="campaign-card">
                    <div class="campaign-card__img">
                      <img src="<?php echo get_theme_file_uri(); ?>/images/common/campaign_4.jpg" alt="ダイビングをしている4人の人が海面に顔を出し話している様子"
                      />
                    </div>
                    <div class="campaign-card__item-body">
                      <div class="campaign-card__meta">
            ...
            <div class="about-us__img-wrap">
              <div class="about-us__img-left">
                <picture>
                  <source
                    media="(max-width: 768px)"
                    srcset="./assets/images/common/about-us_1.jpg"
                  />
              ...
              <div class="about-us__img-right">
                <picture>
                  <source
                    media="(max-width: 768px)"
                    srcset="./assets/images/common/about-us_2.jpg"
                  />
        ...
        <div class="blog__inner inner">
          ...
          <ul class="blog__items blog-cards">
            <li class="blog-cards__item">
              <a href="#" class="blog-card">
                <div class="blog-card__img">
                  <img src="<?php echo get_theme_file_uri(); ?>/images/common/blog_1.jpg" alt="ピンクのサンゴ礁の写真"
                  />
                </div>
                <div class="blog-card__body">
                  <div class="blog-card__meta">
                    <time class="blog-card__time" datetime="2023-11-17"
                      >2023.11/17</time
                    >
            ...
            <li class="blog-cards__item">
              <a href="#" class="blog-card">
                <div class="blog-card__img">
                  <img src="<?php echo get_theme_file_uri(); ?>/images/common/blog_2.jpg" alt="海の中を泳ぐウミガメの写真"
                  />
                </div>
                <div class="blog-card__body">
                  <div class="blog-card__meta">
            ...
            <li class="blog-cards__item">
              <a href="#" class="blog-card">
                <div class="blog-card__img">
                  <img src="<?php echo get_theme_file_uri(); ?>/images/common/blog_3.jpg" alt="珊瑚礁の中にいるカクレクマノミの写真"
                  />
                </div>
                <div class="blog-card__body">
                  <div class="blog-card__meta">
                ...
                <div class="voice-card__body">
                  <div class="voice-card__wrap">
                    ...
                    <div class="voice-card__img">
                      <img src="<?php echo get_theme_file_uri(); ?>/images/common/voice-card_1.jpg" alt="帽子に手を添えて笑っている女性のお客様の写真"
                      />
                    </div>
                  </div>
              ...
              <div class="voice-card">
                <div class="voice-card__body">
                  <div class="voice-card__wrap">
                    ...
                    <div class="voice-card__img">
                      <img src="<?php echo get_theme_file_uri(); ?>/images/common/voice-card_2.jpg" alt="親指を立てるハンドサインをしている男性のお客様の写真"
                      />
                    </div>
                  </div>
          ...
          <div class="price__wrap">
            <picture class="price__img">
              <source
                ...
                srcset="./assets/images/common/price-sp.jpg"
              />
              ...
              <div class="contact__detail">
                ...
                <div class="contact__map-wrap">
                  <div class="contact__map">
                    <iframe
                      src="https://www.google.com/maps/embed?pb=!1m23!1m12!1m3!1d57269.05009306561!2d127.63670374973589!3d26.218932030701666!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!4m8!3e3!4m5!1s0x34e5698332101cf9%3A0xa001fb75096d7c18!2z44CSOTAwLTAwMzIg5rKW57iE55yM6YKj6KaH5biC5p2-5bGx77yR5LiB55uu!3m2!1d26.2188609!2d127.6779035!4m0!5e0!3m2!1sja!2sjp!4v1712753897717!5m2!1sja!2sjp"
                      width="600"
                      height="450"
                      style="border: 0"
                      allowfullscreen=""
